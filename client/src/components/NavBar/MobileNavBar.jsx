						...
						<div className="flex-1">
							<ul className="pt-2 pb-4 space-y-1 text-sm">
								<li className="rounded-sm">
									<NavLink to={"/"} onClick={handleHideNav} rel="noopener noreferrer" href="#" className="flex items-center p-2 space-x-3 rounded-md">
								...
								<li className="rounded-sm">
									<NavLink   onClick={handleHideNav} to={"/discover"} className="flex items-center p-2 space-x-3 rounded-md">
										<BiWorld className="text-2xl text-center" />
										<span>Discover</span>
									</NavLink>
								</li>
								<li className="rounded-sm">
									<NavLink to={"/contact"} onClick={handleHideNav} className="flex items-center p-2 space-x-3 rounded-md">
										<IoMailOpenOutline  className="text-2xl text-center" />
										<span>Contact</span>
									</NavLink>
								</li>
								<li className="rounded-sm">
									<NavLink to={"/register"} onClick={handleHideNav} className="flex items-center p-2 space-x-3 rounded-md bg-black text-white">
									<LiaDoorOpenSolid className="text-2xl text-center" />
